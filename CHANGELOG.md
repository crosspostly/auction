...
- **Логирование**: Логирование событий перенесено из листа `Statistics` (удален) в лист `Logs` (Журнал) для централизации.
...
### Удалено
- **Лист `Statistics`**: Полностью удален из конфигурации и кода. Все логи теперь в `Logs`.
