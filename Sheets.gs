...
const DEFAULT_SETTINGS = {
  ...
  outbid_notification_template: "Ваша ставка перебита! Новая ставка: {new_bid}₽",
  ...
  winner_notification_template: "Поздравляем с победой в аукционе за миниатюру! Напишите в сообщения группы \"Аукцион ({date})\", чтобы забрать свой лот",
